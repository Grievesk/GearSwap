...
function init_gear_sets()
    ...
    sets.precast.JA['Chainspell'] = {body="Dls. tabard +2"} --Vitivation Tabard
    ...
    sets.precast.FC = {ammo="Impatiens",
        head="Warlock's Chapeau",ear2="Loquacious Earring",ear2="Estq. Earring",
        body="Dls. Tabard +2",hands="Gendewitha Gages",ring1="Prolix Ring",
        back="Swith Cape +1",waist="Chuq'aba Belt",legs="Blood cuisses",feet="Augur's gaiters"}
    ...
    sets.midcast.FastRecast = {
        head="Warlock's Chapeau",ear2="Loquacious Earring",
        body="Dls. Tabard +2",hands="Gendewitha Gages",ring1="Prolix Ring",
        back="Swith Cape +1",waist="Witful Belt",legs="Hagondes Pants",feet="Hagondes Sabots"}
--main="Tamaxchi",sub="Genbu's Shield"
    sets.midcast.Cure = {main="Chatoyant Staff",sub="Bugard Strap +1", 
        head="Warlock's Chapeau",neck="Colossus's Torque",ear1="Estq. Earring",ear2="Loquacious Earring",
        body="Gendewitha Bliaut",hands="Augur's Gloves",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Ghostfyre Cape",waist="Duelist's Belt",legs="Atrophy Tights",feet="Estq. Houseaux +2"}
    ...
    sets.midcast['Enhancing Magic'] = {
        ...
        body="Dls. Tabard +2",hands="Atrophy Gloves",ring1="Globidonta Ring",
    ...
    sets.midcast['Enfeebling Magic'] = {main="Baqil Staff",sub="Mephitis Grip",ammo="Demonry Stone",
        head="Dls. Chapeau +2",neck="Atzintli Necklace",ear1="Lifestorm Earring",ear2="Psystorm Earring",
        body="Atrophy tabard",hands="Hagondes cuffs",ring1="Globidonta Ring",ring2="Strendu Ring",
        back={ name="Ghostfyre Cape", augments={'Mag. Acc.+5','Enfb.mag. skill +9',}},waist="Duelist's belt",legs="Estqr. Fuseau +2",feet="Uk'uxkaj boots"}
    ...
    sets.midcast['Dark Magic'] = {main="Baqil Staff",sub="Caecus Grip",ammo="Kalboron Stone",
    ...
    sets.buff.ComposureOther = {head="Estoqueur's Chappel +1",
    ...
    -- Idle sets
    sets.idle = {main="Buramenk'ah",sub="Genbu's Shield",ammo="Impatiens",
        head="Dls. Chapeau +2",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Atrophy Tabard",hands="Atrophy Gloves",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Flume Belt",legs="Blood Cuisses",feet="Gendewitha galoshes"}
    ...
    sets.engaged = {
        head="Atrophy Chapeau +1",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Gendewitha bliaut",hands="Atrophy Gloves",ring1="Rajas Ring",ring2="Candent Ring",
